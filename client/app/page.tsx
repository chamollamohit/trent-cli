            ...
            <div className="w-full max-w-md px-4">
                <div className="space-y-8">
                    ...
                    <div className="border-2 border-dashed border-zinc-700 rounded-2xl p-8 bg-zinc-900/50 backdrop-blur-sm">
                        ...
                        <div className="flex justify-center mb-6">
                            <div className="relative">
                                ...
                                />
                                <div className="absolute -botton-2 -right-2 w-6 h-6 bg-emerald-500 rounded-full border-2 border-zinc-900"></div>
                            </div>
                        </div>
                        {/* User Info */}
                    ...
                    <Button
                        ...
                        className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg transition-colors"
                    >
                        Sign Out
                    </Button>
